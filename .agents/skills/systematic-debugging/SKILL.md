...
- If the issue crosses multiple systems or one hypothesis already failed, request independent
  critique selected by the active orchestration workflow to act as a falsifier.
